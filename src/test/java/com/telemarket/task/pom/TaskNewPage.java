...
public class TaskNewPage extends MainPage {
	...
	public String getTextNew() {return txtDataNew.getAttribute("value");}
	...
	public String getTextNewActivity() {return txtNewActivity.getAttribute("value");}
	@FindBy(id = "tl_user_activity--53053_text")
	protected WebElement txtNewActName;
	public String getTextNewActname() {return txtNewActName.getAttribute("value");}
	...
	public WebElement inputMultiAddPhone;
	public void setTextMultiAddPhone(String in) {inputMultiAddPhone.sendKeys(in);}
	
	@FindBy(xpath = "(//span[@class='ui-button-icon-primary ui-icon ui-icon-close'])[2]")
	protected WebElement btnCloseMultiAddPhone;
	public void clickCloseMultiAddPhone() {btnCloseMultiAddPhone.click();}
	...
	public WebElement btnFirstPagination;
	@FindBy(xpath = "(//a[@href='#'][normalize-space()='>>'])[1]")
	public WebElement btnLastPagination;
	@FindBy(xpath = "(//a[@href='#'][normalize-space()='1'])[1]")
	public WebElement btnPage1;
	...
	public WebElement btnPage5;
	@FindBy(xpath = "(//a[@href='#'][normalize-space()='6'])[1]")
	public WebElement btnPage6;
